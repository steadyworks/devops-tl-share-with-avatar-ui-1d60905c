...
- A **primary message** (2–4 sentences: fun & creative while concise & on-point)
...
Write three distinct versions for the page. Each should:

- Keep the mood but shift the **voice / lens / perspective** — e.g. romantic, celebratory, nostalgic, silly
- Be clearly distinct from each other. It could be style of writing (e.g. Gen-Z for casual vibes), or perspective of the writer (in the voice of a person/pet from the photo vs 3rd party).
